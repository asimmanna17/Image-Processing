...
class SIG17_Training_Dataset(data.Dataset):
    ...
    def __init__(self, root_dir, sub_set, is_training=True):
        ...
        self.scenes_dir = os.path.join(root_dir, self.sub_set)
...
class SIG17_Validation_Dataset(data.Dataset):
    ...
    def __init__(self, root_dir, is_training=False, crop=True, crop_h=1000, crop_w=1000):
        ...
        # sample dir
        self.scenes_dir = os.path.join(root_dir, 'PAPER')
        self.scenes_list = sorted(os.listdir(self.scenes_dir))
